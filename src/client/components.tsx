...
import {
  Button, IconAgentPresetOutline16, IconArchiveOutline20, IconBranchOutline16, IconCloseOutline16, IconFolderClose16, IconFolderOpen16,
  IconFolderOpenOutline16, IconPlusOutline16,
  IconChevronLeftOutline14, IconChevronRightOutline14, IconPaperclipOutline16, IconRefreshOutline16, IconSendOutline16,
  IconRightUpOutline14, IconStopFill16, MarkdownText, MessageText, Modal, Tooltip,
...
function WorkspacePanel({
  ...
  const loadChanges = useCallback(async (): Promise<void> => {
    ...
    try {
      const next = await callAgentTeam<WorkspaceGitStatusView>('team.workspace.changes', { teamId: team.id })
...
function WorkspaceDiffDialog({
  ...
  useEffect(() => {
    ...
    setDiff(undefined)
    setError(undefined)
    void callAgentTeam<WorkspaceGitDiffView>('team.workspace.diff', {
      teamId,
    ...
    >
      <div className={css.workspaceDiffShell}>
        ...
        <div className={css.workspaceDiffBody}>
          ...
          {hasTextPatch && diff !== undefined && (
            <WorkspaceDiffHtml html={diff.html} />
          )}
        </div>
      </div>
    </Modal>
